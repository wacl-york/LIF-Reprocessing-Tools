...
reprocess(log_start_datetime='%d/%m/%Y %H:%M:%S'
, bin_file_path='data/bin_data', HK_file_path='data/HK_data', data_freq=10, skip_start=0, skip_end=0, ignore_first=False, gen_diag_plots=True)
```
